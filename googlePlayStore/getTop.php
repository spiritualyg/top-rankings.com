...
$html = file_get_html('https://play.google.com/store/apps/collection/topselling_free');

// find all link
$resCount=0;

foreach($html->find('li.goog-inline-block') as $e) {
			echo "<div>";
	$imgArr = $e->find('a.thumbnail');
	$imgArr[0]->class = "";
	$imgArr[0]->href = "https://play.google.com/" . $imgArr[0]->href;
	$img = $imgArr[0]->find('img');
	$img[0]->width = 80;
	$img[0]->height = 80;
	echo $imgArr[0]->outertext;
//	echo "<p align='center'>";
	$nameArr = $e->find('a.title');
	$nameArr[0]->href = "https://play.google.com/" . $nameArr[0]->href;
//	$nameArr[0]->align='center';
	$nameArr[0]->style = "font-family:fantasy;font-size:10pt;color:#FF0F08;";

	echo $nameArr[0]->outertext;
//	echo "</p>";
	echo "</div>";
	$resCount++;
}
